...
{{-- dropify --}}
<link rel="stylesheet" type="text/css" href="{{asset('backend/assets/custom/dropify/dropify.min.css')}}">
...
{{-- quill editor --}}
<link rel="stylesheet" href="{{asset('backend/assets/custom/quill/quill.snow.css')}}">
